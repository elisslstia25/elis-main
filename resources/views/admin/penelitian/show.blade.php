                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form class="form-horizontal"
                                                        action="{{ url('admin/penelitian/update-status', $penelitian->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select name="status" class="form-control">
                                                                    <option value="">-- Pilih Status Pengajuan --
                                                                    </option>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-5 col-form-label">Tema</label>
                                                            <div class="col-sm-8">
                                                                <select name="tema" class="form-control">
                                                                    <option value="">-- Pilih Tema Pengajuan --
                                                                    </option>
