                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="tanggung_jawab" value="{{ Auth::guard('dosen')->user()->tanggung_jawab }}">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="tahun_pelaksanaan" value="{{ Auth::guard('dosen')->user()->tahun_pelaksanaan }}">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label>End TKT</label>
                                                                <input type="text" class="form-control" name="end_tkt" value="{{ Auth::guard('dosen')->user()->end_tkt }}">
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="topik_penelitian" value="{{ Auth::guard('dosen')->user()->topik_penelitian }}">
                                                        </div>

                                                        <div class="form-group">
                                                            <label> Lama Kegiatan</label>
                                                            <input type="text" class="form-control" name="lama_kegiatan" value="{{ Auth::guard('dosen')->user()->lama_kegiatan }}">
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="jumlah_pendanaan" value="{{ Auth::guard('dosen')->user()->jumlah_pendanaan }}">
                                                        </div>
